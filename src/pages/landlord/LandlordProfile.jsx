...
const SIDEBAR_LINKS = [
  ...
  { to: '/landlord/profile', icon: '👤', label: 'Profile', active: true },
]
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
            <div style={{ background: 'var(--blue)', borderRadius: '20px', padding: '2rem', textAlign: 'center' }}>
              ...
              <div style={{ position: 'relative', width: '80px', height: '80px', margin: '0 auto 1rem' }}>
                ...
                <label style={{ position: 'absolute', bottom: 0, right: 0, background: 'var(--orange)', borderRadius: '50%', width: '26px', height: '26px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', border: '2px solid white', fontSize: '0.75rem' }}>
                  {uploadingAvatar ? '⏳' : '📷'}
              ...
              <div style={{ fontSize: '0.78rem', color: profile?.verified ? '#4ade80' : 'rgba(255,255,255,0.5)', fontWeight: 600, marginBottom: '0.2rem' }}>
                {profile?.verified ? '✅ Verified Landlord' : '⏳ Verification Pending'}
              </div>
              <div style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.5)' }}>
                {profile?.phone}
              </div>

              <p style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.4)', marginTop: '0.8rem' }}>
            ...
            <div style={{ background: 'var(--card)', borderRadius: '20px', padding: '1.5rem', border: '1px solid var(--beige-dark)' }}>
              <h4 style={{ fontWeight: 700, fontSize: '0.9rem', color: 'var(--blue)', marginBottom: '0.5rem' }}>Account Security</h4>
