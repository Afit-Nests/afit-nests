...
| 14 | FILE_UPLOADS | LOW | [report](reports/FILE_UPLOADS_REPORT.md) | [plan](plans/FILE_UPLOADS_PLAN.md) |
...
- Move production uploads to separate object storage/media domain before high-traffic production use.
